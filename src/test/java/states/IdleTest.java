...
class IdleTest {
	...
	@BeforeEach
	@DisplayName("Setup the Context for testing")
	void setUp() {
	...
	@Test
	@DisplayName("Test the singleton design pattern of the IdleTimer state")
	...
	@Test
	@DisplayName("Test the up event in the IdleTimer state")
	...
	@Test
	@DisplayName("Test the up event in the IdleTimer state with a transition")
	...
	@Test
	@DisplayName("Test the down event in the IdleTimer state")
	void testRight() {
	...
	@Disabled
	@DisplayName("Test the left event in the IdleTimer state")
	void testLeft() {
